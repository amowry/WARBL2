...
function setToDisconnected(){showWARBLNotDetected();showWARBLUnknown();WARBLout=null;WARBLin=null;communicationMode=!1;previousVersion=0;document.getElementById("connect").innerHTML="Connect to WARBL"}
...
function backPressure(){if(version>3.9||version=="Unknown"){document.getElementById("expressionPressureBox").style.display="none";document.getElementById("box9").style.display="block"}}
...
document.getElementById("box7").style.display="block";document.getElementById("expressionPressureBox").style.display="none";document.getElementById("pressureMappingHeader").innerHTML="Velocity Mapping"}
...
document.getElementById("box7").style.display="block";document.getElementById("expressionPressureBox").style.display="none";document.getElementById("pressureMappingHeader").innerHTML="Channel Pressure Mapping"}
...
document.getElementById("box7").style.display="block";document.getElementById("expressionPressureBox").style.display="none";document.getElementById("pressureMappingHeader").innerHTML="Key Pressure Mapping"}
