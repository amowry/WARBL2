...
midiAccess=null;WARBLout=null}else{if(midiAccess){var inputs=midiAccess.inputs.values();for(var input=inputs.next();input&&!input.done;input=inputs.next()){input.value.onmidimessage=null}}
...
case 0x80:noteOff(data1);logKeys;if(notePlaying==data1){document.getElementById("tinyConsole").value=""}
...
var z=document.getElementById("row"+i).value;if(((y==0||(version>4.1&&y==1))&&i<3&&x==1)||((version>1.4||version=="Unknown")&&i<3&&(z==5||z==6||z==10||z==11))){document.getElementById("checkbox"+i).disabled=!1;document.getElementById("switch"+i).style.cursor="pointer"}
if(((((y!=0&&version<=4.1)||(version>4.1&&y>1))&&i<3)||(i<3&&(x==0||x>1)))&&!((version>1.4||version=="Unknown")&&i<3&&(z==5||z==6||z==10||z==11))){document.getElementById("checkbox"+i).disabled=!0;document.getElementById("switch"+i).style.cursor="default";document.getElementById("checkbox"+i).checked=!1}
var q=document.getElementById("checkbox0").checked;if(q==!0){document.getElementById("row5").disabled=!0}else{document.getElementById("row5").disabled=!1}
var r=document.getElementById("checkbox1").checked;if(r==!0){document.getElementById("row6").disabled=!0}else{document.getElementById("row6").disabled=!1}
if(q==!0||r==!0){document.getElementById("row3").disabled=!0}else{document.getElementById("row3").disabled=!1}
var s=document.getElementById("checkbox2").checked;if(s==!0){document.getElementById("row7").disabled=!0}else{document.getElementById("row7").disabled=!1}
