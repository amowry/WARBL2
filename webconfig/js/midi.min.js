...
for(i=12;i<nMessages;++i){byte0=theImportObject.messages[i][0];byte1=theImportObject.messages[i][1];byte2=theImportObject.messages[i][2];if(!(byte1==106&&byte2>=55&&byte2<=57)){sendToWARBL(byte1,byte2)}
await sleep(delay)}
