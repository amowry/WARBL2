...
if(version>4.4){document.getElementById("topcontrolbox").style.height="2320px";document.getElementById("buttonBox").style.top="1850px";document.getElementById("halfHoleSetupBox").style.display="block";document.getElementById("box9").style.display="none";document.getElementById("box3").style.top="1390px";document.getElementById("box3").style.height="375px";document.getElementById("box10").style.display="block";document.getElementById("box10").style.left="527px";document.getElementById("box11").style.left="527px";document.getElementById("box13").style.left="527px";document.getElementById("box12").style.left="527px";document.getElementById("backPressureButton").style.display="none";document.getElementById("backIMUButton").style.display="none";document.getElementById("switch34").style.display="block";document.getElementById("useThumbLabel").style.display="block"}
...
function backPressure(){if((version>3.9&&version<4.5)||version=="Unknown"){document.getElementById("expressionPressureBox").style.display="none";document.getElementById("box9").style.display="block"}}
function backIMU(){if(version<4.5){document.getElementById("box10").style.display="none"}
if((version>3.9&&version<4.5)||version=="Unknown"){document.getElementById("box9").style.display="block"}}
