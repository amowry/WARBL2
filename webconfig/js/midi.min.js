...
if(version>4.3){document.getElementById("IMUpitchMappingControls").style.display="block";document.getElementById("IMUCCMappingControls").style.top="-120px";document.getElementById("IMUbottomControls").style.top="-120px";document.getElementById("IMUpitchMappingControls").style.display="block";document.getElementById("overblowSemitonesInput").style.display="block";document.getElementById("overblowSemitonesLabel").style.display="block"}
