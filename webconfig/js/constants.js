...
const MIDI_CC_104_VALUE_99 = 99; // Bidirectional. Settings for current instrument: indicates ED[50] is about to be sent with CC 105. 
const MIDI_CC_104_VALUE_100 = 100; // Bidirectional. Settings for current instrument: indicates ED[51] is about to be sent with CC 105. 
const MIDI_CC_104_VALUE_101 = 101; // Bidirectional. Settings for current instrument: indicates ED[52] is about to be sent with CC 105. 
const MIDI_CC_104_VALUE_102 = 102; // Bidirectional. Settings for current instrument: indicates ED[53] is about to be sent with CC 105. 
const MIDI_CC_104_VALUE_103 = 103; // Bidirectional. Settings for current instrument: indicates ED[54] is about to be sent with CC 105. 
const MIDI_CC_104_VALUE_104 = 104; // Bidirectional. Settings for current instrument: indicates ED[55] is about to be sent with CC 105. 
...
/* 104-125	unused */
const MIDI_CC_109_VALUE_126 = 126; // From WARBL. Indicates that firmware patch number will be sent on CC 105 
...
const MIDI_EXPRESSION_MIN_HIGH = MIDI_CC_104_VALUE_88; // Bidirectional. Settings for current instrument: indicates ED[39] is about to be sent with CC 105. 
const MIDI_EXPRESSION_MAX_LOW = MIDI_CC_104_VALUE_89; // Bidirectional. Settings for current instrument: indicates ED[40] is about to be sent with CC 105. 
