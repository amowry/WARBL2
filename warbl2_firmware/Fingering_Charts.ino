...
const struct tinwhistle_explicit_entry tinwhistle_explicit[256] = {
    // Sensor numbers from left to right are L1,L2,L3,R1,R2,R3,R4. The bell sensor is ignored.
    // Whistle and uilleann have an extra entry after the MIDI note for custom vibrato.
    { 73, 0 },         //00000000
    { 73, 0 },         //00000001
    { 73, 0 },         //00000010
    { 73, 0 },         //00000011
    ...
    { 72, 0 },         //00101110
    { 72, 0 },         //00101111
    { 72, 0b000010 },  //00110000
    { 72, 0b000010 },  //00110001
    { 72, 1 },         //00110010
    { 72, 1 },         //00110011
    { 72, 1 },         //00110100
    { 72, 1 },         //00110101
    ...
    { 74, 0 },         //00111110
    { 74, 0 },         //00111111
    { 71, 0b000010 },  //01000000
    { 71, 0b000010 },  //01000001
    { 71, 1 },         //01000010
    { 71, 1 },         //01000011
    { 71, 1 },         //01000100
    { 71, 1 },         //01000101
    ...
    { 70, 0 },         //01011110
    { 70, 0 },         //01011111
    { 69, 0b000010 },  //01100000
    { 69, 0b000010 },  //01100001
    { 69, 1 },         //01100010
    { 69, 1 },         //01100011
    { 69, 1 },         //01100100
    { 69, 1 },         //01100101
    ...
    { 68, 0 },         //01101110
    { 68, 0 },         //01101111
    { 67, 0b000010 },  //01110000
    { 67, 0b000010 },  //01110001
    { 67, 1 },         //01110010
    { 67, 1 },         //01110011
    { 67, 1 },         //01110100
    { 67, 1 },         //01110101
    ...
    { 72, 0 },         //10101110
    { 72, 0 },         //10101111
    { 72, 0b000010 },  //10110000
    { 72, 0b000010 },  //10110001
    { 72, 1 },         //10110010
    { 72, 1 },         //10110011
    { 72, 1 },         //10110100
    { 72, 1 },         //10110101
    ...
    { 74, 0 },         //10111110
    { 74, 0 },         //10111111
    { 71, 0b000010 },  //11000000
    { 71, 0b000010 },  //11000001
    { 71, 1 },         //11000010
    { 71, 1 },         //11000011
    { 71, 1 },         //11000100
    { 71, 1 },         //11000101
    ...
    { 70, 0 },         //11011110
    { 70, 0 },         //11011111
    { 69, 0b000010 },  //11100000
    { 69, 0b000010 },  //11100001
    { 69, 1 },         //11100010
    { 69, 1 },         //11100011
    { 69, 1 },         //11100100
    { 69, 1 },         //11100101
    ...
    { 68, 0 },         //11101110
    { 68, 0 },         //11101111
    { 67, 0b000010 },  //11110000
    { 67, 0b000010 },  //11110001
    { 67, 1 },         //11110010
    { 67, 1 },         //11110011
    { 67, 1 },         //11110100
    { 67, 1 },         //11110101
...
const struct uilleann_explicit_entry uilleann_explicit[128] = {
    ...
    { 72, 0 },         //0111011 C
    //{72, 0}, //0111100 C
    { 73, 0 },         //0111100 C# //changd from C 10/21
...
const struct GHB_explicit_entry GHB_explicit[128] = {
    ...
    { 71 },  //1011100 F#
    { 71 },  //1011101 F#
    { 70 },  //1011110 F (changed from F# 8/2022)
    { 71 },  //1011111 F#
    { 69 },  //1100000 E
    { 69 },  //1100001 E
    { 69 },  //1100010 E
...
const struct sax_explicit_entry sax_explicit[64] = {
...
const struct saxbasic_explicit_entry saxbasic_explicit[128] = {
...
//Medieval Pipes
struct medievalPipes_explicit_entry {
    uint8_t midi_note;
};

const struct medievalPipes_explicit_entry medievalPipes_explicit[128] = {
    { 75 },  //0000000 G#
    { 74 },  //0000001 G
    { 74 },  //0000010 G
    { 74 },  //0000011 G
...
//Bansuri
struct bansuri_explicit_entry {
    uint8_t midi_note;
};

const struct bansuri_explicit_entry bansuri_explicit[64] = {
